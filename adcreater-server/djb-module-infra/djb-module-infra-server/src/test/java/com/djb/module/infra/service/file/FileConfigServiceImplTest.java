package com.djb.module.infra.service.file;
...
import com.djb.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.djb.module.infra.dal.dataobject.file.FileConfigDO;
import com.djb.module.infra.dal.mysql.file.FileConfigMapper;
import com.djb.module.infra.framework.file.core.client.FileClient;
import com.djb.module.infra.framework.file.core.client.FileClientConfig;
import com.djb.module.infra.framework.file.core.client.FileClientFactory;
import com.djb.module.infra.framework.file.core.client.local.LocalFileClient;
import com.djb.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.djb.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.djb.framework.test.core.util.RandomUtils.randomLongId;
import static com.djb.framework.test.core.util.RandomUtils.randomPojo;
import static com.djb.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.djb.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        assertEquals("domain", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("domain")));
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("djbadmin")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("domain");

        // 调用，并断言
        assertEquals("domain", fileConfigService.testFileConfig(id));
    }
