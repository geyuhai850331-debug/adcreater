package com.djb.module.infra.service.logger;
...
import com.djb.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.djb.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.djb.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.djb.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.djb.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.djb.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("djb-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @DJB：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
