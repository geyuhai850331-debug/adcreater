package com.djb.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.djb.framework.common.pojo.PageResult;
import com.djb.framework.test.core.ut.BaseDbUnitTest;
import com.djb.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.djb.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.djb.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.djb.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.djb.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.djb.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.djb.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.djb.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.djb.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.djb.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.djb.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.djb.module.infra.enums.codegen.CodegenSceneEnum;
import com.djb.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.djb.module.infra.framework.codegen.config.CodegenProperties;
import com.djb.module.infra.service.codegen.inner.CodegenBuilder;
import com.djb.module.infra.service.codegen.inner.CodegenEngine;
import com.djb.module.infra.service.db.DataSourceConfigService;
import com.djb.module.infra.service.db.DatabaseTableService;
...
import static com.djb.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.djb.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.djb.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.djb.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.djb.framework.test.core.util.AssertUtils.assertServiceException;
import static com.djb.framework.test.core.util.RandomUtils.*;
import static com.djb.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("DJB");
    ...
    public void testGetDatabaseTableList() {
        ...
        assertEquals("DJB", result.get(0).getComment());
    }
