package com.djb.module.infra.controller.admin.logger.vo.apiaccesslog;

import com.djb.framework.excel.core.annotations.DictFormat;
import com.djb.framework.excel.core.convert.DictConvert;
import com.djb.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "djbadmin，牛逼！")
    @ExcelProperty("结果提示")
