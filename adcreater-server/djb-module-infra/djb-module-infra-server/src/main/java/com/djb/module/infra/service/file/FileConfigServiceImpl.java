...
import com.djb.module.infra.convert.file.FileConfigConvert;
...
import static com.djb.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public void updateFileConfigMaster(Long id) {
        ...
        // 更新其它为非 master
        FileConfigDO updateAllObj = new FileConfigDO();
        updateAllObj.setMaster(false);
        fileConfigMapper.updateBatch(updateAllObj);
        // 更新
