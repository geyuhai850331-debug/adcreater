package com.djb.module.infra.controller.admin.codegen;
...
import com.djb.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.djb.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.djb.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.djb.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.djb.module.infra.convert.codegen.CodegenConvert;
...
import com.djb.module.infra.service.codegen.CodegenService;
...
import static com.djb.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.djb.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "djb"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "DJB")
    })
