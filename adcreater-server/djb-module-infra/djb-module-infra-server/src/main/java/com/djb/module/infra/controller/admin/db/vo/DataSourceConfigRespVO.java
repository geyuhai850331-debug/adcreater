package com.djb.module.infra.controller.admin.db.vo;
...
public class DataSourceConfigRespVO {
    ...
    @Schema(description = "数据源连接", requiredMode = Schema.RequiredMode.REQUIRED, example = "jdbc:mysql://192.168.10.218:3306/djb-framework-master")
    private String url;
