package com.djb.module.system.service.tenant;
...
import com.djb.framework.datapermission.core.annotation.DataPermission;
import com.djb.framework.tenant.config.TenantProperties;
import com.djb.framework.tenant.core.context.TenantContextHolder;
import com.djb.framework.tenant.core.util.TenantUtils;
import com.djb.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.djb.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.djb.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.djb.module.system.convert.tenant.TenantConvert;
import com.djb.module.system.dal.dataobject.permission.MenuDO;
import com.djb.module.system.dal.dataobject.permission.RoleDO;
import com.djb.module.system.dal.dataobject.tenant.TenantDO;
import com.djb.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.djb.module.system.dal.mysql.tenant.TenantMapper;
import com.djb.module.system.service.permission.MenuService;
...
import com.djb.module.system.service.tenant.handler.TenantInfoHandler;
import com.djb.module.system.service.tenant.handler.TenantMenuHandler;
import com.djb.module.system.service.user.AdminUserService;
import com.djb.module.system.enums.permission.RoleCodeEnum;
import com.djb.module.system.enums.permission.RoleTypeEnum;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 djb.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
