...
import com.djb.module.system.mq.message.mail.MailSendMessage;
import com.djb.module.system.mq.producer.mail.MailProducer;
...
public class MailSendServiceImpl implements MailSendService {
    ...
    @VisibleForTesting
    public MailTemplateDO validateMailTemplate(String templateCode) {
        // 获得邮件模板。考虑到效率，从缓存中获取
     ...
     */
    @VisibleForTesting
    public void validateTemplateParams(MailTemplateDO template, Map<String, Object> templateParams) {
