package com.djb.module.system.controller.admin.auth.vo;
...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "djbadmin")
        private String nickname;

        @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "domain/xx.jpg")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "DJB")
        private Long id;
        ...
        @Schema(description = "菜单英文名称（国际化）", example = "Menu")
