...
import com.djb.module.system.controller.admin.socail.vo.user.SocialUserPageReqVO;
import com.djb.module.system.dal.dataobject.social.SocialUserBindDO;
import com.djb.module.system.dal.dataobject.social.SocialUserDO;
import com.djb.module.system.dal.mysql.social.SocialUserBindMapper;
import com.djb.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.djb.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    public SocialUserDO authSocialUser(Integer socialType, Integer userType, String code, String state) {
        ...
        if (socialUser.getId() == null) {
            ...
            socialUser.clean(); // 避免 updateTime 不更新：https://gitee.com/djbcode/djb-boot-mini/issues/ID7FUL
