package com.djb.module.system.service.auth;
...
import com.djb.module.system.controller.admin.auth.vo.*;
import com.djb.module.system.convert.auth.AuthConvert;
...
import com.djb.module.system.service.member.MemberService;
import com.djb.module.system.service.oauth2.OAuth2TokenService;
import com.djb.module.system.service.social.SocialUserService;
...
import com.djb.module.system.enums.logger.LoginLogTypeEnum;
import com.djb.module.system.enums.logger.LoginResultEnum;
import com.djb.module.system.enums.oauth2.OAuth2ClientConstants;
...
public class AdminAuthServiceImpl implements AdminAuthService {
    ...
    public void sendSmsCode(AuthSmsSendReqVO reqVO) {
        ...
        // 发送验证码
        SmsCodeSendReqDTO smsDto = AuthConvert.INSTANCE.convert(reqVO);
        smsDto.setCreateIp(getClientIP());
        smsCodeApi.sendSmsCode(smsDto);
    }
