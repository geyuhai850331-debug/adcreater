...
import com.djb.module.system.dal.dataobject.sms.SmsCodeDO;
import com.djb.module.system.dal.mysql.sms.SmsCodeMapper;
import com.djb.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.djb.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO DJB：提升，每个 IP 每天可发送数量
            // TODO DJB：提升，每个 IP 每小时可发送数量
        }
