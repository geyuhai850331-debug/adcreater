package com.djb.module.system.service.social;
...
import com.djb.framework.common.util.cache.CacheUtils;
import com.djb.framework.common.util.http.HttpUtils;
import com.djb.framework.common.util.object.BeanUtils;
import com.djb.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.djb.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.djb.module.system.dal.dataobject.social.SocialClientDO;
import com.djb.module.system.dal.mysql.social.SocialClientMapper;
import com.djb.module.system.dal.redis.RedisKeyConstants;
import com.djb.module.system.framework.justauth.core.AuthRequestFactory;
import com.djb.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.djb.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.djb.module.system.enums.social.SocialTypeEnum;
...
import static com.djb.framework.common.util.collection.MapUtils.findAndThen;
import static com.djb.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.djb.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.djb.framework.common.util.json.JsonUtils.toJsonString;
import static com.djb.module.system.enums.ErrorCodeConstants.*;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${djb.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${djb.wxa-subscribe-message.miniprogram-state:formal}")
     ...
     */
    @VisibleForTesting
    public WxMpService getWxMpService(Integer userType) {
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/djb-cloud/pulls/230
