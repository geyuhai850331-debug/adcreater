package com.djb.module.system.controller.admin.oauth2;
...
import com.djb.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.djb.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.djb.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.djb.module.system.convert.oauth2.OAuth2OpenConvert;
import com.djb.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.djb.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.djb.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.djb.module.system.service.oauth2.OAuth2ApproveService;
import com.djb.module.system.service.oauth2.OAuth2ClientService;
import com.djb.module.system.service.oauth2.OAuth2GrantService;
import com.djb.module.system.service.oauth2.OAuth2TokenService;
import com.djb.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.djb.module.system.util.oauth2.OAuth2Utils;
...
import static com.djb.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.djb.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
import static com.djb.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "domain"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "domain"),
