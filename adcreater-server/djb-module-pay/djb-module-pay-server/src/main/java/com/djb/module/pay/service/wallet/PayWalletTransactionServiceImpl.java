...
import com.djb.module.pay.controller.admin.wallet.vo.transaction.PayWalletTransactionPageReqVO;
import com.djb.module.pay.controller.app.wallet.vo.transaction.AppPayWalletTransactionPageReqVO;
import com.djb.module.pay.controller.app.wallet.vo.transaction.AppPayWalletTransactionSummaryRespVO;
import com.djb.module.pay.convert.wallet.PayWalletTransactionConvert;
...
import com.djb.module.pay.dal.mysql.wallet.PayWalletTransactionMapper;
import com.djb.module.pay.dal.redis.no.PayNoRedisDAO;
import com.djb.module.pay.enums.wallet.PayWalletBizTypeEnum;
import com.djb.module.pay.service.wallet.bo.WalletTransactionCreateReqBO;
...
import static com.djb.module.pay.controller.app.wallet.vo.transaction.AppPayWalletTransactionPageReqVO.TYPE_EXPENSE;
import static com.djb.module.pay.controller.app.wallet.vo.transaction.AppPayWalletTransactionPageReqVO.TYPE_INCOME;
...
public class PayWalletTransactionServiceImpl implements PayWalletTransactionService {
    ...
    public AppPayWalletTransactionSummaryRespVO getWalletTransactionSummary(Long userId, Integer userType, LocalDateTime[] createTime) {
        ...
        respVO.setTotalExpense(payWalletTransactionMapper.selectPriceSum(wallet.getId(), TYPE_EXPENSE, createTime));
        respVO.setTotalIncome(payWalletTransactionMapper.selectPriceSum(wallet.getId(), TYPE_INCOME, createTime));
        return respVO;
    }
