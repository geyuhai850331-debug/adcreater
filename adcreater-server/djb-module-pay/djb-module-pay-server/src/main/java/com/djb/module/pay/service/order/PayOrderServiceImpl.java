package com.djb.module.pay.service.order;
...
import com.djb.framework.common.util.number.MoneyUtils;
...
public class PayOrderServiceImpl implements PayOrderService {
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/djb-cloud/issues/I8SM9H 场景
     ...
     */
    @VisibleForTesting
    public void validateOrderActuallyPaid(Long id) {
