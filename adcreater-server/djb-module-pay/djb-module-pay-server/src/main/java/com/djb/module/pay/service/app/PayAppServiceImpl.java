package com.djb.module.pay.service.app;
...
public class PayAppServiceImpl implements PayAppService {
    ...
    public void updateAppStatus(Long id, Integer status) {
        ...
        // 更新状态
        PayAppDO updateObj = new PayAppDO();
        updateObj.setId(id);
