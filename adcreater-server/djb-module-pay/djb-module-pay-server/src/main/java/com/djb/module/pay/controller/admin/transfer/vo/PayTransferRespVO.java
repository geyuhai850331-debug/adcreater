package com.djb.module.pay.controller.admin.transfer.vo;

import com.djb.framework.excel.core.annotations.DictFormat;
import com.djb.framework.excel.core.convert.DictConvert;
import com.djb.framework.excel.core.convert.MoneyConvert;
import com.djb.module.pay.enums.DictTypeConstants;
...
public class PayTransferRespVO {
    ...
    @ExcelProperty("应用名称")
    @Schema(description = "应用名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "DJB")
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "domain")
