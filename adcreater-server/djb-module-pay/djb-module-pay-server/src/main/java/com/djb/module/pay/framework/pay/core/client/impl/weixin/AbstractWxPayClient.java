package com.djb.module.pay.framework.pay.core.client.impl.weixin;
...
import com.djb.framework.common.util.io.FileUtils;
...
import static com.djb.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.djb.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/djbcode/djb-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // TODO @DJB：【可能是 wxjava 的 bug】参考 https://github.com/binarywang/WxJava/issues/1557
    ...
    protected PayTransferRespDTO doUnifiedTransfer(PayTransferUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        try {
            ...
            if (ObjectUtils.equalsAny(state, "ACCEPTED", "PROCESSING", "WAIT_USER_CONFIRM", "TRANSFERING")) {
                PayTransferRespDTO respDTO = PayTransferRespDTO.processingOf(response.getTransferBillNo(), response.getOutBillNo(), response);
                respDTO.setChannelPackageInfo(response.getPackageInfo()); // 一般情况下，只有 WAIT_USER_CONFIRM 会有！
                return respDTO;
            }
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/djb-cloud/issues/ICSFL6
