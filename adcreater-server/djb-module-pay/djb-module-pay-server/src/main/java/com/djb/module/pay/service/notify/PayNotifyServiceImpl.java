package com.djb.module.pay.service.notify;
...
import com.djb.module.pay.api.notify.dto.PayOrderNotifyReqDTO;
import com.djb.module.pay.api.notify.dto.PayRefundNotifyReqDTO;
import com.djb.module.pay.api.notify.dto.PayTransferNotifyReqDTO;
...
import static com.djb.module.pay.framework.job.config.PayJobConfiguration.NOTIFY_THREAD_POOL_TASK_EXECUTOR;
...
public class PayNotifyServiceImpl implements PayNotifyService {
    ...
    public void createPayNotifyTask(Integer type, Long dataId) {
        ...
        task.setMaxNotifyTimes(PayNotifyTaskDO.NOTIFY_FREQUENCY.length + 1);
     ...
     */
    @VisibleForTesting
    public Integer processNotifyResult(PayNotifyTaskDO task, CommonResult<?> invokeResult, Throwable invokeException) {
        ...
        updateTask.setNotifyTimes(task.getNotifyTimes() + 1);
