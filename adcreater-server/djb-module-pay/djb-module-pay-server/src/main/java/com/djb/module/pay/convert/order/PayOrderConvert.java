package com.djb.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.djb.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
