...
import com.djb.framework.mybatis.core.util.MyBatisUtils;
import com.djb.framework.redis.config.DjbCacheProperties;
import com.djb.framework.security.core.service.SecurityFrameworkService;
import com.djb.framework.tenant.core.aop.TenantIgnore;
import com.djb.framework.tenant.core.aop.TenantIgnoreAspect;
import com.djb.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.djb.framework.tenant.core.job.TenantJobAspect;
import com.djb.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.djb.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.djb.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.djb.framework.tenant.core.redis.TenantRedisCacheManager;
import com.djb.framework.tenant.core.security.TenantSecurityWebFilter;
import com.djb.framework.tenant.core.service.TenantFrameworkService;
import com.djb.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.djb.framework.tenant.core.web.TenantContextWebFilter;
import com.djb.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class DjbTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/djb-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "com.djb.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     DjbCacheProperties djbCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(djbCacheProperties.getRedisScanBatchSize()));
