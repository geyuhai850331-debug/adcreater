package com.djb.framework.common.biz.system.oauth2;

import com.djb.framework.common.enums.RpcConstants;
...
@FeignClient(name = RpcConstants.SYSTEM_NAME) // TODO DJB：fallbackFactory =
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "djbyuanma")
    })
