package com.djb.framework.jackson.config;

import com.djb.framework.common.util.json.JsonUtils;
import com.djb.framework.common.util.json.databind.NumberSerializer;
import com.djb.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.djb.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class DjbJacksonAutoConfiguration {
