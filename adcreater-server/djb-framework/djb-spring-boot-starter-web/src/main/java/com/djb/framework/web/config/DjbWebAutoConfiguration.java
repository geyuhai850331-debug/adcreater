package com.djb.framework.web.config;
...
import com.djb.framework.web.core.filter.CacheRequestBodyFilter;
import com.djb.framework.web.core.filter.DemoFilter;
import com.djb.framework.web.core.handler.GlobalExceptionHandler;
import com.djb.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class DjbWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "djb.demo", havingValue = "true")
