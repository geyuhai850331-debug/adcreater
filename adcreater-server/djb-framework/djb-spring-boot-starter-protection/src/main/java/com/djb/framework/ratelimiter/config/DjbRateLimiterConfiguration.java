package com.djb.framework.ratelimiter.config;

import com.djb.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.djb.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.djb.framework.ratelimiter.core.keyresolver.impl.*;
import com.djb.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class DjbRateLimiterConfiguration {
