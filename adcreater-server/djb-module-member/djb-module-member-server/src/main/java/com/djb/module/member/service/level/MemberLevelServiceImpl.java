package com.djb.module.member.service.level;
...
import com.djb.module.member.controller.admin.level.vo.level.MemberLevelListReqVO;
import com.djb.module.member.controller.admin.level.vo.level.MemberLevelUpdateReqVO;
import com.djb.module.member.controller.admin.user.vo.MemberUserUpdateLevelReqVO;
import com.djb.module.member.convert.level.MemberLevelConvert;
import com.djb.module.member.convert.level.MemberLevelRecordConvert;
...
import com.djb.module.member.dal.mysql.level.MemberLevelMapper;
...
public class MemberLevelServiceImpl implements MemberLevelService {
    ...
    public void updateUserLevel(MemberUserUpdateLevelReqVO updateReqVO) {
        ...
        levelRecord.setUserId(user.getId());
        levelRecord.setRemark(updateReqVO.getReason());
    ...
    public void addExperience(Long userId, Integer experience, MemberExperienceBizTypeEnum bizType, String bizId) {
        ...
        MemberLevelRecordDO levelRecord = new MemberLevelRecordDO();
        levelRecord.setUserId(user.getId());
        levelRecord.setExperience(experience);
        levelRecord.setUserExperience(userExperience);
        levelRecord.setLevelId(user.getLevelId());
