package com.djb.module.member.controller.admin.level.vo.level;

import com.djb.framework.common.enums.CommonStatusEnum;
import com.djb.framework.common.validation.InEnum;
...
public class MemberLevelBaseVO {
    ...
    @Schema(description = "等级背景图", example = "domain/djb.jpg")
