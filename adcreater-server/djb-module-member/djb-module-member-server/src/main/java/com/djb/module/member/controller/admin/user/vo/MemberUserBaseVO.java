package com.djb.module.member.controller.admin.user.vo;
...
import static com.djb.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY;
...
public class MemberUserBaseVO {
    ...
    @Schema(description = "头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "domain/x.png")
