...
import com.djb.framework.common.enums.TerminalEnum;
...
import static com.djb.framework.web.core.util.WebFrameworkUtils.getTerminal;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    private AppAuthLoginRespVO createTokenAfterLoginSuccess(MemberUserDO user, String mobile,
        ...
        createReqDTO.setUserId(user.getId());
        createReqDTO.setUserType(getUserType().getValue());
        createReqDTO.setClientId(OAuth2ClientConstants.CLIENT_ID_DEFAULT);
        OAuth2AccessTokenRespDTO accessTokenRespDTO = oauth2TokenApi.createAccessToken(createReqDTO).getCheckedData();
        // 构建返回结果
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO DJB：后续 member user 手机非强绑定，这块需要做下调整；
        ...
        smsCodeApi.sendSmsCode(sendReqDTO).checkError();
    }
