...
import com.djb.framework.common.util.collection.MapUtils;
import com.djb.framework.common.util.date.DateUtils;
import com.djb.framework.common.util.object.BeanUtils;
import com.djb.module.member.controller.admin.signin.vo.record.MemberSignInRecordRespVO;
import com.djb.module.member.controller.app.signin.vo.record.AppMemberSignInRecordRespVO;
...
public interface MemberSignInRecordConvert {
    ...
    default PageResult<MemberSignInRecordRespVO> convertPage(PageResult<MemberSignInRecordDO> pageResult) {
        return BeanUtils.toBean(pageResult, MemberSignInRecordRespVO.class);
    }

    default PageResult<AppMemberSignInRecordRespVO> convertPage02(PageResult<MemberSignInRecordDO> pageResult) {
        return BeanUtils.toBean(pageResult, AppMemberSignInRecordRespVO.class);
    }

    default AppMemberSignInRecordRespVO coverRecordToAppRecordVo(MemberSignInRecordDO memberSignInRecordDO) {
        return BeanUtils.toBean(memberSignInRecordDO, AppMemberSignInRecordRespVO.class);
    }
