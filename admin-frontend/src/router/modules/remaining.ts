...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'dashboard',
        component: () => import('@/views/adcreater/dashboard/index.vue'),
        name: 'AdCreaterDashboard',
        meta: { title: '仪表盘', icon: 'ep:data-analysis' }
      },
      {
        path: 'users',
        component: () => import('@/views/adcreater/user/index.vue'),
        name: 'AdCreaterUser',
        meta: { title: '用户管理', icon: 'ep:user' }
      },
      {
        path: 'billing',
        component: () => import('@/views/adcreater/billing/index.vue'),
        name: 'AdCreaterBilling',
        meta: { title: '点数管理', icon: 'ep:wallet' }
      },
      {
        path: 'models',
        component: () => import('@/views/adcreater/model/index.vue'),
        name: 'AdCreaterModel',
        meta: { title: '模型配置', icon: 'ep:cpu' }
      },
      {
        path: 'prompts',
        component: () => import('@/views/adcreater/prompt/index.vue'),
        name: 'AdCreaterPrompt',
        meta: { title: 'Prompt 配置', icon: 'ep:edit-pen' }
      },
      {
        path: 'templates',
        component: () => import('@/views/adcreater/template/index.vue'),
        name: 'AdCreaterTemplate',
        meta: { title: '模板管理', icon: 'ep:files' }
      }
    ]
  },
  {
